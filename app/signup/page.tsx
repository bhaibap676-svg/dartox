...
export default function Signup() {
  ...
  const [formData, setFormData] = useState({
    ...
    // Business details (if business seller)
    businessName: '',
    gstNumber: '',
    
    // Location (for individual seller - OLX style)
    city: '',
    pincode: '',
    
    // Bank details for Razorpay
    bankAccount: '',
    bankIfsc: '',
  });
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 to-purple-700 p-12 flex-col justify-between">
        ...
        <p className="text-white/60 text-sm">
          © 2024 Dartox. All rights reserved.
        </p>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <p className="text-gray-600 mb-8">
            Join thousands of sellers on Dartox
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    ...
                    <button
                      type="button"
                      onClick={() => setFormData({ ...formData, role: 'INDIVIDUAL_SELLER' })}
                      className={`p-4 rounded-xl border-2 text-center transition-all ${
                        formData.role === 'INDIVIDUAL_SELLER' 
                    ...
                    <button
                      type="button"
                      onClick={() => setFormData({ ...formData, role: 'BUSINESS_SELLER' })}
                      className={`p-4 rounded-xl border-2 text-center transition-all ${
                  ...
                  <p className="text-xs text-gray-500 mt-2">
                    {formData.role === 'INDIVIDUAL_SELLER' && '📱 OLX-style: Sell used items quickly with negotiation'}
                    {formData.role === 'BUSINESS_SELLER' && '🏪 Flipkart-style: Full-featured online store'}
                    {formData.role === 'BUYER' && '🛒 Browse and buy products'}
                  </p>
                </div>
            ...
            {/* Step 3: Bank Details for Razorpay */}
            {step === 3 && (
              <div className="space-y-5">
                <div className="bg-green-50 p-4 rounded-xl">
                  <h3 className="font-medium text-green-900 mb-1">💳 Connect Bank Account</h3>
                  <p className="text-sm text-green-700">
                    Receive payments directly to your bank via Razorpay
                  </p>
                </div>
                ...
                <p className="text-xs text-gray-500">
                  🔒 Your bank details are securely encrypted and stored with Razorpay
                </p>
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    className="flex-1 bg-blue-600 text-white py-3 rounded-xl font-medium hover:bg-blue-700 transition-colors flex items-center justify-center gap-2"
                  >
                    {loading ? 'Creating...' : 'Complete Signup'} <ArrowRight className="w-5 h-5" />
                  </button>
                </div>
              </div>
            )}
